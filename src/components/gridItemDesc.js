  ...
  return (
    <div className="griddescwrapper">
      <div className="columns is-mobile">
        ...
        <div className="column is-three-quarters-mobile is-two-thirds-tablet is-half-desktop is-one-third-widescreen is-one-quarter-fullhd videodetail">
          <div className="videoDetails">
            <div className="videoDetailsrow">
            <h4>
              <b>{itemDetails.EventName}</b>
            </h4>
            <a href="#"  className="close" onClick={closeItem}><MdClose/></a>
            </div>
          ...
          <div className="ratingVotes columns is-mobile">
